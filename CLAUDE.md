...
OAuth, Supabase backend (9 Edge Functions, migrations 0001–0043), self-healing shared CC0
...
cleanup-omission bug, whichever first. Migrations run **0001–0043**; highlights: 0012–0015 friendship graph + friend-read RLS +
...
0037–0039 the Wave 5b public tier (`get_public_crate` + 0043's `get_public_crate_summary` are the anon-granted functions — advisor WARN by design), 0040 ledger `master_year`, 0041–0043 the v1.31 cold audit (finalize-link authz #131; for-sale dedupe #135; anon `/c`+`/og` summary RPC #200/#158), 0034–0036 the v1.25 audit waves (A: data lifecycle; B: atomic cooldown + invite preview + private ACLs;
