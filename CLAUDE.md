...
OAuth, Supabase backend (9 Edge Functions, migrations 0001–0039), self-healing shared CC0
...
cleanup-omission bug, whichever first. Migrations run **0001–0039**; highlights: 0012–0015 friendship graph + friend-read RLS +
